...
namespace JunioHub.Application.Services
{
    internal class OfferService : IOfferService
    {
        ...
        public OfferService(IOfferRepository offerRepository, ITechnologyRepository technologyRepository, IMapper mapper, IEmployerRepository employerRepository, ILogger<OfferService> logger, IApplicationRepository applicationRepository)
        {
